...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-2xl text-sm font-semibold font-inter ring-offset-background transition-all duration-300 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 [&_svg]:flex-shrink-0 relative overflow-hidden",
  {
    variants: {
      variant: {
        default: "bg-[#13294b] text-white hover:bg-[#1f3d66] hover:shadow-xl hover:shadow-[#13294b]/25 hover:-translate-y-1 active:translate-y-0 active:scale-95",
        destructive:
        ...
        outline:
          "border-2 border-[#13294b] bg-transparent text-[#13294b] hover:bg-[#13294b] hover:text-white hover:shadow-xl hover:shadow-[#13294b]/25 hover:-translate-y-1 active:translate-y-0 active:scale-95 before:absolute before:inset-0 before:bg-[#13294b] before:scale-x-0 before:transition-transform before:duration-300 hover:before:scale-x-100 before:-z-10",
        secondary:
        ...
        link: "text-[#13294b] underline-offset-4 hover:underline hover:text-[#1f3d66] transition-colors",
