        ...
        <div className="relative mx-auto max-w-7xl px-4 py-10 md:py-12">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-4xl">
              ...
              <p className="mt-3 max-w-3xl text-sm font-medium leading-relaxed !text-violet-100 md:text-base">
                {subtitle ||
                  'Gerencie sua loja, produtos, pedidos, estoque e financeiro em um só lugar.'}
              </p>
            </div>
        ...
        {!isMobile && (
          <aside className="sticky top-6 h-fit w-72 shrink-0 rounded-3xl border border-slate-200 bg-white p-4 shadow-sm">
            <div className="mb-4 flex items-center gap-3 rounded-2xl bg-violet-50 p-4">
              ...
              <div>
                <p className="text-sm font-black text-slate-950">Área da Loja</p>
                <p className="text-xs font-medium text-slate-500">Painel do fornecedor</p>
              </div>
            </div>
                    ...
                    <div
                      className={cn(
                        ...
                        active
                          ...
                          : 'bg-slate-100 text-slate-600 group-hover:bg-violet-100 group-hover:text-violet-800'
                      )}
                    >
