      ...
      <div className="container mx-auto px-4">
                          ...
                          <div className="flex flex-wrap gap-2 justify-center">
                            {technician.specialties.map((specialty, index) => (
                              <Badge 
                                key={index} 
                                variant="secondary" 
                                className="bg-blue-100 text-blue-800 text-xs px-2 py-1 font-inter"
                              >
                                {specialty}
                              </Badge>
                            ))}
        ...
        <div className="text-center mt-8">
          <Link to="/find-technician">
            <Button 
              variant="outline" 
              className="border-2 border-blue-600 text-blue-800 hover:bg-blue-50 font-semibold px-6 py-3 rounded-lg font-inter"
            >
