...
const Hero = () => {
  return <section className="bg-gradient-to-br from-instalei-purple-500 via-instalei-purple-600 to-instalei-purple-700 text-white section-padding min-h-[80vh] flex items-center relative overflow-hidden">
      ...
      <div className="container-instalei w-full relative z-10">
        {/* Botões de ação rápida no topo - Instalei */}
        <div className="flex flex-wrap justify-center gap-instalei-md mb-instalei-lg">
        ...
        <div className="text-center mb-instalei-xl">
          <h1 className="text-5xl md:text-7xl font-black mb-instalei-lg leading-tight text-white drop-shadow-2xl">
            Encontre o <span className="text-instalei-orange-400 bg-gradient-to-r from-instalei-orange-500/30 to-instalei-orange-400/30 rounded-instalei-lg border-2 border-instalei-orange-400/50 backdrop-blur-sm mx-px font-bold text-7xl px-[20px] py-0">técnico ideal</span><br />
          ...
          <p className="text-2xl md:text-3xl mb-instalei-lg text-instalei-gray-200 max-w-4xl mx-auto font-bold leading-relaxed drop-shadow-lg">
            Conectamos você com profissionais qualificados através da plataforma <span className="text-instalei-orange-300 font-black">Instalei</span>
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-instalei-lg text-center">
          <div className="bg-white/20 backdrop-blur-xl rounded-instalei-lg p-instalei-lg border-2 border-white/30 shadow-2xl hover:bg-white/25 transition-all duration-300 hover:scale-105 hover:shadow-3xl">
            <div className="text-5xl font-black text-instalei-orange-300 mb-instalei-sm drop-shadow-lg">98%</div>
            <div className="text-instalei-gray-200 font-bold text-xl drop-shadow-lg">Taxa de Satisfação</div>
          </div>
          <div className="bg-white/20 backdrop-blur-xl rounded-instalei-lg p-instalei-lg border-2 border-white/30 shadow-2xl hover:bg-white/25 transition-all duration-300 hover:scale-105 hover:shadow-3xl">
            <div className="text-5xl font-black text-instalei-orange-300 mb-instalei-sm drop-shadow-lg">24h</div>
            <div className="text-instalei-gray-200 font-bold text-xl drop-shadow-lg">Tempo Médio de Resposta</div>
          </div>
          <div className="bg-white/20 backdrop-blur-xl rounded-instalei-lg p-instalei-lg border-2 border-white/30 shadow-2xl hover:bg-white/25 transition-all duration-300 hover:scale-105 hover:shadow-3xl">
            <div className="text-5xl font-black text-instalei-orange-300 mb-instalei-sm drop-shadow-lg">15K+</div>
            <div className="text-instalei-gray-200 font-bold text-xl drop-shadow-lg">Serviços Realizados</div>
          </div>
        </div>
      </div>
    </section>;
