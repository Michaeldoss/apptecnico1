...
const bulletPoints = [
  "Profissionais homologados para impressão digital, comunicação visual e corte a laser",
  "Checklists guiados, orçamentos e aprovações em um único painel",
  "Atendimento em campo ou remoto com garantia Instalei"
];
...
const trustedBy = ["Atos", "Klabin", "Raízen", "Coca-Cola FEMSA", "Tilibra"];
        ...
        <div className="space-y-10">
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-white/80 md:text-xl">
              A Instalei centraliza chamados para bureaus, redes varejistas e operações de comunicação visual. Solicite suporte emergencial,
              cadastre manutenção preventiva e acompanhe cada passo com total transparência.
            </p>
          </div>
            ...
            <CardContent className="space-y-6">
              <div className="grid gap-6 md:grid-cols-[1.3fr_1fr]">
                <div className="space-y-3">
                  <label className="text-sm font-semibold text-white" htmlFor="equipment">
                    Tipo de equipamento
                  </label>
          ...
          <div className="grid gap-6 sm:grid-cols-3">
            {metrics.map(metric => (
              <div
                key={metric.label}
                className="rounded-2xl border border-white/15 bg-white/10 p-6 text-center shadow-sm backdrop-blur"
              >
