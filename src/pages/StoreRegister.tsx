...
const storeFormSchema = z.object({
  ...
  nome_contato: z.string().min(2, "Nome do contato deve ter pelo menos 2 caracteres"),
      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="max-w-2xl mx-auto">
          <AnimatedContainer animation="scale" className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold">Cadastro de Loja</h1>
            <p className="text-muted-foreground mt-2">
              Registre sua empresa para vender produtos na plataforma
            </p>
          </AnimatedContainer>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input placeholder="Sala 10, Loja A..." {...field} />
                        </FormControl>
                        <FormMessage />
                      </FormItem>
                    )}
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Textarea
                            placeholder="Descreva sua empresa, área de atuação e tipos de produtos que oferece..."
                            className="min-h-[100px]"
                            {...field}
                          />
                        </FormControl>
                        <FormDescription>
                          Conte sobre sua empresa para atrair mais clientes
                        </FormDescription>
                        <FormMessage />
                      </FormItem>
                    )}
