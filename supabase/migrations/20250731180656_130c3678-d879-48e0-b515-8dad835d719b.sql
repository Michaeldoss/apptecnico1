-- Criar usuários de teste com senhas conhecidas e tipos corretos
...
-- Adicionar entradas na tabela usuarios para mapeamento de tipos (USANDO OS TIPOS CORRETOS)
...
SELECT u.id, 
       ...
       u.email,
       CASE 
         WHEN u.email = 'cliente@exemplo.com.br' THEN 'cliente'
         WHEN u.email = 'tecnico@exemplo.com.br' THEN 'tecnico'
